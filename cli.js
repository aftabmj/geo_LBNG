...
var dataSource = loopback.createDataSource('geo', {
    'host' : 'localhost',
    'port': 1433,
    'url' : '',
...
function main(options) {
    ...
    // cli.error("server path : " + serverPath);
    // cli.error("model config opath :" +  modelConfigPath);
    // cli.error("modelsPath : " + modelsPath);

     /*
    try {
        //server = require(serverPath);
        //cli.error("options.dataSource : " + options.dataSource);
        //dataSource = server.dataSources[options.dataSource];
        //cli.error("dataSource : " + dataSource)
    } catch(e) {
        cli.error(e);
